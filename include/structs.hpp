...
{
	int numOfSecs;
	std::vector<int> numOfHdrsPerSec;
...
struct BoneHeaderData
{
	...
	std::vector<int> numOfBoneHdrsPerAnim;
	std::vector<int> numOfSecBoneHdrsPerAnim;
	std::vector<int> numOfSecBoneHdrsPerSec;
	...
	std::vector<int> secOffsets;
	int animBytesAdded;
	int secBytesAdded;
	std::vector<int> strStartPos;
	int numOfSecs;
};
...
struct AnimData
{
	...
	std::vector<int> bytesAddedToSec;
