...
class BinaryReader{
  ...
  std::fstream Stream;
    ...
    void Read(seqweightlist_t_v49* data);
    ...
    void Read(mstudioskingroup_t_v49* data);
...
class BinaryWriter{
  ...
  std::fstream Stream;
    ...
    void Write(mstudioskingroup_t_v49 data);
    void Write(mstudionodedata_v49 data);
    void Write(mstudionodename_t_v49 data);
    void Write(pertriheader_t_v49 data);

    void Write(mstudiobbox_tv53 data);
    void Write(mstudioanimdesc_tv53 data);
    void Write(mstudioikrule_tv53 data);
